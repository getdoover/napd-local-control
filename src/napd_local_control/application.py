...
from .app_ui import NapdLocalControlUI
from .app_state import NapdLocalControlState
...
class NapdLocalControlApplication(Application):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.ui: NapdLocalControlUI = None
        self.state: NapdLocalControlState = None

    async def setup(self):
        self.ui = NapdLocalControlUI()
        self.state = NapdLocalControlState()
