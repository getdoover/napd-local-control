...
class NapdLocalControlConfig(config.Schema):
    def __init__(self):
        ...
        self.pump_1_fault_LED_pin = config.Integer("Pump 1 Stop LED Pin", description="The pump 1 stop LED pin")
        
        self.pump_2_start_LED_pin = config.Integer("Pump 2 Start LED Pin", description="The pump 2 start LED pin")
        self.pump_2_fault_LED_pin = config.Integer("Pump 2 Stop LED Pin", description="The pump 2 stop LED pin")
